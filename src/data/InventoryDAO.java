...
public interface InventoryDAO {
	final Comparator<Album> ALBUM_SORT_DEFAULT = 
		new Comparator<Album>() {
			public int compare(Album a, Album b) {
				// sortName, date, title
				String[] aFields = { 
						a.getArtist().getSortName().toUpperCase(),
						"" + a.getYear(),
						a.getTitle().toUpperCase()
						};
			
				String[] bFields = { 
						b.getArtist().getSortName().toUpperCase(),
						"" + b.getYear(),
	...
	final Comparator<Artist> ARTIST_SORT_DEFAULT = 
			(a,b) -> a.getSortName().toUpperCase().compareTo(b.getSortName().toUpperCase());
